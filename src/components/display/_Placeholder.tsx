                    ...
                    sx={
                        {
                            ...
                            ...(videoSrc ? { background: 'none' } : { backgroundImage: `url(${background})` }),
                        } as SxProps<Theme>
                    }
                >
                    ...
                    />
                    {videoSrc && (
                        <Box component={'video'} sx={styles.video} controls src={videoSrcString}>
                            Your browser does not support the video tag.
                        </Box>
                    )}
                </Box>
                <label htmlFor={`file-picker-${title}`}>
                    <Button variant={'text'} color={'primary'} component={'span'} sx={{ mt: 1 }}>
                        {videoSrc ? <Edit sx={{ mr: 0.5 }} /> : <AddAPhoto sx={{ mr: 0.5 }} />}
