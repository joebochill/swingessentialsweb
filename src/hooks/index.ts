...
export const useVideoValid = (
  video = "",
  setVideoStatus: (status: YoutubeVideoStatus) => void
): void => {
  useEffect((): void => {
    ...
    fetch(
      `https://www.youtube.com/oembed?format=json&url=http://www.youtube.com/watch?v=${video}`,
      {
        method: "GET",
      }
    )
