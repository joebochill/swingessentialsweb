    ...
    return (
        <>
            <Banner background={{ src: bg, position: 'center 70%', opacity: 0.5 }} justify={'center'}>
                {!initialized && <div style={{ color: 'white' }}><CircularProgress color={'inherit'} /></div>}
                {initialized &&
                    <div className={classes.root}>
                        <div className={classes.imageWrapper}>
                            <div className={classes.avatar} style={{ backgroundImage: `url(https://www.swingessentials.com/images/profiles/${user.image ? `${user.username}/image.jpeg` : 'blank.png'}` }}>
                            ...
                            <div className={classes.name}>
                                ...
                                <Button variant={'outlined'} color={'inherit'} style={{ marginTop: 16 }}>Change Password</Button>
                            </div>
                        </div>
