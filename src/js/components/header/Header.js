        ...
        <ul className="se_menu_list">
          ...
          {(this.props.token) && (
            <li className={this.props.menuOpen ? "se_drop_menu open" : "se_drop_menu"}>
              <span onClick={this.props.menuOpen ? () => this.props.closeMenu() : () => this.props.openMenu()}>
                {this.props.fname ?
              ...
              <div className={this.props.menuOpen ? "se_account_menu" : "se_account_menu closed"}>
                <div className="se_menu_panel_links">
                  ...
                  <span onClick={() => { this.props.requestLogout(this.props.token); this.props.closeMenu(); }}>Sign Out</span>
                </div>
              </div>
            </li>
          )}
