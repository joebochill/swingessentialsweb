    ...
    return (
      <div>
        ...
        <div>
          ...
          <section className="left">
            <div className="structured_panel wide">
              <label>X. GENERAL PROVISIONS</label>
              <p>If any provision of these Terms of Use is, for any reason, held to be invalid or unenforceable, the other provisions of these Terms of Use will be unimpaired and the invalid or unenforceable provision will be deemed modified so that it is valid and enforceable to the maximum extent permitted by law. These Terms of Use and any action related thereto will be governed, controlled, interpreted, and defined by and under the laws of the Commonwealth of Virginia , without giving effect to any principles that require the application of the law of a different jurisdiction. By using this Site, you hereby expressly consent to the personal jurisdiction and venue in the state and federal courts for Fairfax County, Virginia, and you agree that any claim brought by you pursuant to these Terms of Use will be brought solely in those courts and no other court.</p>
