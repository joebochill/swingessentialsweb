    ...
    return (
      <div>
        ...
        <section className="left">
          <Datestamp month="APR" day="10" year="2017"/>
          ...
          <p>1. Get the right shaft flex. The right shaft won’t be too heavy. It may be steel or graphite, but
          ...
          shafts. You are probably in the middle.</p>
          <p>2. Get the right length. Length is important, but
          ...
          toe, you need a little length.</p>
          <p>3. Grip is important. People have different size
        ...
        <section className="left">
          <Datestamp month="FEB" day="18" year="2017"/>
        ...
        <section className="left">
          <Datestamp month="DEC" day="01" year="2016"/>
        ...
        <section className="left">
          <Datestamp month="OCT" day="01" year="2016"/>
        ...
        <section className="left">
          <Datestamp month="SEP" day="09" year="2016"/>
