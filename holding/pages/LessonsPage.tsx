    ...
    return (
        <>
            ...
            <Section align={isSmall ? 'stretch' : 'flex-start'}>
                ...
                <Spacer classes={{}} flex={0} width={theme.spacing(8)} />
                                            ...
                                            actions={
                                                admin ? (
                                                    <FlexFlipper flipAt={'xs'}>
                                                        ...
                                                        <Spacer classes={{}} flex={0} width={16} height={16} />
                                                        <Button
                                                            style={{ flex: '1 1 0px' }}
                                                            variant={'contained'}
                                                            color={'primary'}
                                ...
                                {activeLesson.fo_swing !== '' && activeLesson.dtl_swing !== '' && (
                                    <>
                                        <div style={{ width: '100%', display: 'flex' }}>
                                            ...
                                            <Spacer classes={{}} flex={0} width={theme.spacing(2)} height={theme.spacing(2)} />
                                            <div style={{ flex: '1 1 0px', background: 'black' }}>
                                                <video
                                                    width="100%"
                                                    controls
                                        ...
                                        <Spacer classes={{}} flex={0} height={theme.spacing(2)} />
                                    </>
                                )}
